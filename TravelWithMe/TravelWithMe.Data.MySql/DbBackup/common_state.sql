...
CREATE TABLE `state` (
  ...
  PRIMARY KEY (`StateCode`,`CountryCode`),
  KEY `CountryCode_idx` (`CountryCode`),
  CONSTRAINT `CountryCode` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`CountryCode`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2013-05-02 19:59:42
