...
CREATE TABLE `bankaccount` (
  ...
  `AccountHolderName` varchar(128) DEFAULT NULL,
  `AccountNumber` varchar(45) DEFAULT NULL,
  `AddDate` timestamp NULL DEFAULT NULL,
  `ModifiedDate` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `User_BankAccount_idx` (`UserId`),
  CONSTRAINT `User_BankAccount` FOREIGN KEY (`UserId`) REFERENCES `account` (`AccountId`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2013-05-02 19:59:37
