...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`CityId`),
  KEY `City_Of_State_idx` (`StateCode`),
  CONSTRAINT `City_Of_State` FOREIGN KEY (`StateCode`) REFERENCES `state` (`StateCode`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-05-02 19:59:38
