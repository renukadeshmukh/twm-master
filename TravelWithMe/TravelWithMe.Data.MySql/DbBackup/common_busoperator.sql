...
CREATE TABLE `busoperator` (
  ...
  KEY `BusOperator_Account_idx` (`OperatorId`),
  CONSTRAINT `BusOperator_Account` FOREIGN KEY (`OperatorId`) REFERENCES `account` (`AccountId`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2013-05-02 19:59:33
